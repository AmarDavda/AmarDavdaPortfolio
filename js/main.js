...
function loadContactPage() {
    ...
    document.getElementById("contactEmailBtn").href = `mailto:${contact.item.find(i => i.title === "Email").content}?subject=Contact from portfolio&body=Hello Amar, I would like to connect with you.`;
